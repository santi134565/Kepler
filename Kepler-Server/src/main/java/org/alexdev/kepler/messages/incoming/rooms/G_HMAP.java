...
public class G_HMAP implements MessageEvent {
    ...
    public void handle(Player player, NettyRequest reader) throws Exception {
        ...
        if (gamePlayer != null && gamePlayer.getGame() instanceof SnowwarGame) {
            SnowwarGame game = (SnowwarGame) gamePlayer.getGame();
        ...
        if (gamePlayer != null) {
            ...
            if (gamePlayer.getGame() instanceof SnowwarGame) {
                SnowwarGame game = (SnowwarGame) gamePlayer.getGame();
